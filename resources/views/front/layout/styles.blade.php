...
<link rel="stylesheet" href="{{ asset('dist-front/css/iziToast.min.css') }}">
  ...
  <!-- Owl Stylesheets -->
  <link rel="stylesheet" href="{{ asset('dist-front/css/owlcarousel/owl.carousel.min.css')}}">
  <link rel="stylesheet" href="{{ asset('dist-front/css/owlcarousel/owl.theme.default.min.css')}}">
